...
// █████████████████████████████████████████████
  ...
  urlTestList.forEach(item => {
    proxyGroups.push({
      name: item.name, type: "url-test", proxies: item.proxies, "include-all": true,
      filter: item.filter, "empty-fallback": "REJECT", hidden: true, timeout: 3000, "max-failed-times": 2,
